...
$item_diag = "CESAREA";
$tem = "Item:";
$tem2 = utf8_decode("CURVA DE TOLERANCIA ORAL");
$tem3 = utf8_decode("A LA GLUCOSA CON 75gr de glucosa en 325gr de agua");
$tem4 = utf8_decode('Dosaje 0-60"-120"');
$tem5 = utf8_decode('Insulinemia basal -120"');
...
$pdf_orden->Output('CTGO_Clinica.pdf','D');
