...
$diag = "Solicito:";
$tem = "Item:";
$item_diag = utf8_decode("UROCULTIVO");
$tem2 = utf8_decode("Recuento de colonias");
$tem3 = utf8_decode("Tipificación de germen");
$tem4 = utf8_decode("Antibiograma");
...
$pdf_orden->ln(6);
$pdf_orden->MultiCell(0,5,$item_diag,0,'C');
$pdf_orden->ln(6);
...
$pdf_orden->Output('Orden_urocultivo.pdf','D');
