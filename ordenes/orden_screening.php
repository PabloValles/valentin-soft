...
$diag = "Solicito:";
$tem = "Item:";
$item_diag = utf8_decode("Screening cromosomopatías.");
$tem2 = utf8_decode("PAPPA");
$tem3 = utf8_decode("SBHCG cuantitativa");
$tem4 = utf8_decode("a Feto proteína");
$tem5 = utf8_decode("Estradiol Libre");
...
$pdf_orden->MultiCell(0,5,$tem2,0,'C');
$pdf_orden->ln(3);
$pdf_orden->MultiCell(0,5,$tem3,0,'C');
$pdf_orden->ln(3);
$pdf_orden->MultiCell(0,5,$tem4,0,'C');
$pdf_orden->ln(3);
$pdf_orden->MultiCell(0,5,$tem5,0,'C');
$pdf_orden->ln(6);
$pdf_orden->ln(6);
$pdf_orden->ln(6);
$pdf_orden->ln(3);
$pdf_orden->SetFont('Times','B',13);
$pdf_orden->cell(0,5,"Diag: $item_diag");
$pdf_orden->ln(3);
$pdf_orden->SetLeftMargin(10);
$pdf_orden->Output('Orden_Screening.pdf','D');
