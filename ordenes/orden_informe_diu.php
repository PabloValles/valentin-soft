...
$solicito = "";
$diag = " ";
$tem = "En la fecha se le ha colocado a la paciente el dispositivo intrauterino (DIU) sin mayor dificultad.";
$tem2 = "Se recomienda control a la semana y al mes";
$tem3 = utf8_decode("Diag: Anticoncepción");
...
$pdf_orden->SetLeftMargin(10);
$pdf_orden->Output('informe_diu.pdf','D');
