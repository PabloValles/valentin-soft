...
$diag = "Solicito:";
$tem = "Item:";
//$item_diag = utf8_decode("Infección urinaria");
$tem2 = utf8_decode("Ecografía obstétrica");
$tem3 = utf8_decode("TN-HN");
$tem4 = utf8_decode("DOPPLER DE ARTERIAS UTERINAS");
...
$pdf_orden->ln(6);
$pdf_orden->SetFont('Times','B',13);
$pdf_orden->cell(0,5,"Diag: Control de embarazo de 12 semanas");
$pdf_orden->ln(3);
$pdf_orden->SetLeftMargin(10);
$pdf_orden->Output('Orden_Art_Uterinas.pdf','D');
