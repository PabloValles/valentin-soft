...
$item_diag = "CESAREA";
$tem = "Item:";
$tem2 = utf8_decode("TIPIFICACION");
$tem3 = utf8_decode("Y FACTOR RH");
$tem4 = utf8_decode("EMB 40 SEM");
...
$pdf_orden->ln(6);
$pdf_orden->SetFont('Times','B',13);
$pdf_orden->cell(0,5,"Diag: Cesarea");
$pdf_orden->ln(5);
$pdf_orden->cell(0,5,$tem4);

$pdf_orden->ln(3);
$pdf_orden->SetLeftMargin(10);
$pdf_orden->Output('Orden_tipificacion.pdf','D');
