...
$tem2 = utf8_decode("CLEARANCE DE CREATININA");
$tem3 = utf8_decode("PROTEINURIA DE 24 hs.");
$tem4 = utf8_decode("TALLA: ");
$tem5 = utf8_decode("PESO: ");
...
$pdf_orden->ln(6);
$pdf_orden->MultiCell(0,5,$tem4,0,'L');
$pdf_orden->ln(3);
$pdf_orden->MultiCell(0,5,$tem5,0,'L');
$pdf_orden->ln(6);
$pdf_orden->ln(6);
$pdf_orden->ln(6);
$pdf_orden->ln(3);
...
$pdf_orden->Output('Orden_Clearance.pdf','D');
