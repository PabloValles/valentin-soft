...
$tem2 = utf8_decode("CULTIVO DE FLUJO VAGINAL ");
$tem3 = utf8_decode("E HISOPADO PERIANAL");
$tem4 = utf8_decode('Búsqueda de Streptococcus')." ".sprintf("%c",223);
$tem5 = utf8_decode("Hemolítico Grupo B (agalactie) ");
...
$pdf_orden->ln(6);
$pdf_orden->MultiCell(0,5,$tem5);
$pdf_orden->ln(6);
$pdf_orden->ln(6);
$pdf_orden->ln(6);
$pdf_orden->SetFont('Times','B',13);
$pdf_orden->cell(0,5,"Diag: Embarazo");
$pdf_orden->ln(3);
$pdf_orden->SetLeftMargin(10);
$pdf_orden->Output('Orden_ctgo.pdf','D');
